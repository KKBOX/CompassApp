...
Gem::Specification.new do |s|
  ...
  s.files = [".document", ".gitignore", "CHANGELOG.md", "MIT-LICENSE", "README.md", "Rakefile", "TODO.md", "VERSION", "lemonade.gemspec", "lib/lemonade.rb", "lib/lemonade/lemonade.rb", "lib/lemonade/sass_extensions/functions/lemonade.rb", "spec/images/other_images/more-images/sprites/test.png", "spec/images/other_images/test.png", "spec/images/sprites/10x10.png", "spec/images/sprites/150x10.png", "spec/images/sprites/20x20.png", "spec/images/sprites/30x30.png", "spec/lemonade_spec.rb", "spec/spec.opts", "spec/spec_helper.rb"]
  s.homepage = %q{http://github.com/hagenburger/lemonade}
  s.rdoc_options = ["--charset=UTF-8"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.3.6}
  s.summary = %q{On the fly sprite generator for Sass/Compass}
  s.test_files = ["spec/lemonade_spec.rb", "spec/spec_helper.rb"]
